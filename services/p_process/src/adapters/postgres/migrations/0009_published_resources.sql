-- Migration 0009: Published resources and knowledge library (Story 2.2)
-- Stores SOP/FAQ records and allows querying effective published knowledge
...
-- Seed Data: 3 published documents and 1 draft document for testing and demo
