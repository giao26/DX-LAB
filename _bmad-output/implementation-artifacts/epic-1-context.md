...
Epic này tạo một lát cắt nghiệp vụ hoàn chỉnh từ lúc khách gửi yêu cầu đến khi nhân viên xử lý và đóng ticket. Hệ thống thực hiện phân công công bằng, theo dõi SLA, bảo vệ dữ liệu theo trách nhiệm và duy trì một mã ticket xuyên suốt form, email, Odoo và các tích hợp; đồng thời thiết lập lõi P và chính sách quyền có thể dùng lại cho các epic sau.
...
- Story 1.9: Nhân viên xử lý ticket theo quy trình và SLA, người phụ trách đóng ticket
...
- Phân công chỉ chọn nhân viên sẵn sàng trong nhóm phù hợp với loại yêu cầu khách chọn, ưu tiên số lượt nhận chính thức thấp nhất rồi quay vòng theo ID tăng dần. Mỗi người có tối đa một ticket hoạt động hoặc giữ chỗ; chọn và giữ chỗ phải nguyên tử. Khi mọi người bận, ticket chờ FIFO và SLA vẫn chạy.
...
- Sự kiện đóng chuyển ticket sang `CLOSED`, lưu kết quả xử lý và giải phóng năng lực để phân công ticket chờ tiếp theo.
...
- Thay đổi trạng thái, phân công và kết quả xử lý phải có lịch sử gồm tác nhân, thời gian UTC, correlation/nguồn và giá trị trước/sau. Lệnh cùng side effect phải idempotent; cập nhật đồng thời dùng điều kiện phiên bản.

## Technical Decisions

- P là nơi duy nhất thay đổi ticket, phân công, bước xử lý. Luật nghiệp vụ nằm trong lõi domain/application TypeScript; Odoo, Web và Node-RED chỉ đi qua API hoặc sự kiện đã commit.
...
- Luồng xem thông báo, mở ticket, nhận trách nhiệm, ghi bước và đóng phải dùng được trên desktop lẫn trình duyệt điện thoại, bằng bàn phím, không cuộn ngang tại 320 CSS px hoặc zoom 200%.
- Hành động đóng phải xác nhận ngay trong ngữ cảnh và nêu hậu quả ngắn gọn.

## Cross-Story Dependencies

- Story 1.1–1.2 tạo cấu trúc, hợp đồng, profile và ranh giới triển khai cho toàn bộ lát cắt còn lại.
- Ticket hợp lệ và mã ticket từ Story 1.3 là đầu vào cho email, tệp, quyền, phân công, xử lý và đóng ticket; Story 1.4–1.5 bổ sung side effect và bằng chứng nhưng không được làm thay đổi tính nguyên tử của việc tạo ticket.
- Chính sách quyền ở Story 1.6 áp dụng xuyên suốt Story 1.7–1.9. Story 1.7 phân công trực tiếp nhân viên theo loại yêu cầu do khách chọn và gửi thông báo qua Odoo.
- Story 1.9 cho phép người phụ trách bắt đầu xử lý, thực hiện các bước theo quy trình và SLA, sau đó đóng ticket khi hoàn tất (chuyển sang `CLOSED` và giải phóng năng lực để phân công ticket chờ tiếp theo).
