...
- Bổ sung vận hành 26/09/2026 theo yêu cầu mới: đã cấu hình client Web/portal:read/PKCE/audience trên realm hiện có, tạo khóa phiên local và cập nhật Web/P. HTTPS localhost với Keycloak/P thật PASS cho staff.warranty/director, H/P, cookie flags, staff Dashboard deny, director I allow và logout xóa cookie; hoàn tất required profile tên/họ của tài khoản director. Không reset mật khẩu, không xóa dữ liệu/volume. Odoo `/dx/tickets/workspace` trả 502 nên chưa xác minh chuyển vào Odoo; chưa mutate role/disable tài khoản thật. Checklist và giới hạn tại `../../docs/portal.md`, sprint vẫn review.
