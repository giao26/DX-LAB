...
export default async function ProcessPage() {
  ...
  return (
    <>
      ...
      <p className="portal-subtitle">Danh mục các quy trình vận hành số được phép sử dụng.</p>
      ...
      <section aria-labelledby="ticket-heading" className="portal-block process-card">
        ...
        <a href="/" className="btn-primary process-cta">Mở biểu mẫu DX-Ticket →</a>
      </section>

      <section aria-labelledby="upcoming-heading" className="portal-block">
        <h2 id="upcoming-heading">Quy trình khác</h2>
        <p className="empty-text">Các quy trình khác sẽ sớm ra mắt.</p>
      </section>
    </>
  );
}
